#!/bin/bash 
#
# Generate SR-IOV Network Node Policy for Ethernet devices
...
if [ "$#" -lt 3 ]; then
  ...
  echo "Examples:"
  echo "  Single device:   $0 sriovnet-rdma-default-a-su-1-cr a 0000:24:00.0"
  echo "  Multiple devices: $0 sriovnet-rdma-default-a-su-1-cr a 0000:24:00.0,0000:25:00.0"
  echo "  Interface names:  $0 sriovnet-rdma-default-a-su-1-cr a eth0,eth1"
  exit 1
fi
...
echo "Generating SR-IOV Ethernet node policy for:" >&2
